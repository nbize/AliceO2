...
class GloFwdAssessment
{
 ...
 private:
  ...
  enum TH3HistosCodes {
    ...
    kTH3GMTrackTanlPullMFTPtEta,
    kTH3GMTrackInvQPtPullMFTPtEta,
    // Global Fwd residuals
    kTH3GMTrackXResPtEta,
    kTH3GMTrackYResPtEta,
    kTH3GMTrackPhiResPtEta,
    kTH3GMTrackTanlResPtEta,
    kTH3GMTrackInvQPtResPtEta,
  ...
  std::map<int, const char*> TH3Names{
    ...
    {kTH3GMTrackTanlResMCHPtEta, "TH3GMTrackTanlResMCHPtEta"},
    ...
    {kTH3GMTrackTanlPullMCHPtEta, "TH3GMTrackTanlPullMCHPtEta"},
    ...
    {kTH3GMTrackTanlResMFTPtEta, "TH3GMTrackTanlResMFTPtEta"},
    ...
    {kTH3GMTrackTanlPullMFTPtEta, "TH3GMTrackTanlPullMFTPtEta"},
    {kTH3GMTrackInvQPtPullMFTPtEta, "TH3GMTrackInvQPtPullMFTPtEta"},
    // Global Fwd residuals
    {kTH3GMTrackXResPtEta, "TH3GMTrackXResPtEta"},
    {kTH3GMTrackYResPtEta, "TH3GMTrackYResPtEta"},
    {kTH3GMTrackPhiResPtEta, "TH3GMTrackPhiResPtEta"},
    {kTH3GMTrackTanlResPtEta, "TH3GMTrackTanlResPtEta"},
    {kTH3GMTrackInvQPtResPtEta, "TH3GMTrackInvQPtResPtEta"},
    // Global Fwd pull distributions
  ...
  std::map<int, std::array<double, 9>> TH3Binning{
    ...
    {kTH3GMTrackTanlResMCHPtEta, {40, 0, 20, 16, 2.2, 3.8, 1000, -5, 5}},
    ...
    {kTH3GMTrackTanlPullMCHPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -10, 10}},
    ...
    {kTH3GMTrackPhiPullMFTPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackTanlPullMFTPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackInvQPtPullMFTPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -10, 10}},
    // Global Fwd residuals
    {kTH3GMTrackXResPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackYResPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackPhiResPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackTanlResPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    {kTH3GMTrackInvQPtResPtEta, {40, 0, 20, 16, 2.2, 3.8, 200, -5, 5}},
    // Global Fwd pull distributions
  ...
  std::map<int, const char*> TH3XaxisTitles{
    ...
    {kTH3GMTrackTanlResMCHPtEta, R"(p_{t}_{MC})"},
    ...
    {kTH3GMTrackTanlPullMCHPtEta, R"(p_{t}_{MC})"},
    ...
    {kTH3GMTrackTanlResMFTPtEta, R"(p_{t}_{MC})"},
    ...
    {kTH3GMTrackTanlPullMFTPtEta, R"(p_{t}_{MC})"},
    {kTH3GMTrackInvQPtPullMFTPtEta, R"(p_{t}_{MC})"},
    // Global Fwd residuals
    {kTH3GMTrackXResPtEta, R"(p_{t}_{MC})"},
    {kTH3GMTrackYResPtEta, R"(p_{t}_{MC})"},
    {kTH3GMTrackPhiResPtEta, R"(p_{t}_{MC})"},
    {kTH3GMTrackTanlResPtEta, R"(p_{t}_{MC})"},
    {kTH3GMTrackInvQPtResPtEta, R"(p_{t}_{MC})"},
  ...
  std::map<int, const char*> TH3YaxisTitles{
    ...
    {kTH3GMTrackTanlResMCHPtEta, R"(\eta_{MC})"},
    ...
    {kTH3GMTrackTanlPullMCHPtEta, R"(\eta_{MC})"},
    ...
    {kTH3GMTrackTanlResMFTPtEta, R"(\eta_{MC})"},
    ...
    {kTH3GMTrackTanlPullMFTPtEta, R"(\eta_{MC})"},
    {kTH3GMTrackInvQPtPullMFTPtEta, R"(\eta_{MC})"},
    // Global Fwd residuals
    {kTH3GMTrackXResPtEta, R"(\eta_{MC})"},
    {kTH3GMTrackYResPtEta, R"(\eta_{MC})"},
    {kTH3GMTrackPhiResPtEta, R"(\eta_{MC})"},
    {kTH3GMTrackTanlResPtEta, R"(\eta_{MC})"},
    {kTH3GMTrackInvQPtResPtEta, R"(\eta_{MC})"},
    // Global Fwd pull distribution
  ...
  std::map<int, const char*> TH3ZaxisTitles{
    ...
    {kTH3GMTrackTanlResMCHPtEta, R"(tan#lambda_{MCH-residual}/tan#lambda_{MCH})"},
    ...
    {kTH3GMTrackTanlResMCHPtEta, R"(\Delta \tan(\lambda)/\sigma_{tan(\lambda)})"},
    ...
    {kTH3GMTrackTanlResMFTPtEta, R"(tan#lambda_{MFT-residual}/tan#lambda_{MFT})"},
    ...
    {kTH3GMTrackTanlPullMFTPtEta, R"(\Delta \tan(\lambda)/\sigma_{tan(\lambda)})"},
    {kTH3GMTrackInvQPtPullMFTPtEta, R"((\Delta q/p_t)/\sigma_{q/p_{t}})"},
    // Global Fwd residuals
    {kTH3GMTrackXResPtEta, R"(\Delta X)"},
    {kTH3GMTrackYResPtEta, R"(\Delta Y)"},
    {kTH3GMTrackPhiResPtEta, R"(\Delta \phi)"},
    {kTH3GMTrackTanlResPtEta, R"(\Delta \tan(\lambda))"},
    {kTH3GMTrackInvQPtResPtEta, R"((\Delta q/p_t))"},
    // Global Fwd pull distributions
